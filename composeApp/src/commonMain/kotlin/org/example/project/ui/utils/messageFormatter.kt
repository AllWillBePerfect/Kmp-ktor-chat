    ...
    return when (matchResult.value.first()) {
        ...
        '*' -> SymbolAnnotation(
            AnnotatedString(
                ...
                spanStyle = SpanStyle(fontWeight = FontWeight.Companion.Bold),
            ),
            null,
        )
        ...
        '_' -> SymbolAnnotation(
            AnnotatedString(
                ...
                spanStyle = SpanStyle(fontStyle = FontStyle.Companion.Italic),
            ),
            null,
        )
        ...
        '~' -> SymbolAnnotation(
            AnnotatedString(
                text = matchResult.value.trim('~'),
                spanStyle = SpanStyle(textDecoration = TextDecoration.Companion.LineThrough),
            ),
            null,
        )
        ...
        else -> SymbolAnnotation(androidx.compose.ui.text.AnnotatedString(matchResult.value), null)
    }
}